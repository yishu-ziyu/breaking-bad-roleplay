...
- Rights / disclosure (always bind, including if clone-TTS is revisited): authorized samples only (hired VO, self-recorded, or rights-cleared). Do not commit raw show rips. Do not claim “official actor voice”.
